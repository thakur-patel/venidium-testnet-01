// /* 
// This file uses Metamask's method: "eth_signTypedData_v4"
// So, the data types created are in sync with the parameter inputs of eth_signTypedData_v4()
// Conclusion: Since I am creating a testing script, I do not have access to MetaMask function eth_signTypedData_v4()
// So, the only way to use this is to study the function and rewrite the function in this script.
// This is a drag, so I am not going with this.
// */
